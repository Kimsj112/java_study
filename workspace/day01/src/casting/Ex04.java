...
//		String, 클래스.... -> 앞 글자가 대문자, 클래스 자료형, *참조 자료형,reference type (배열도 참조 자료형)
...
//		String -> 기본 자료형
//		기본 자료형은 기본 자료형끼리 형변환이 됨.
//		클래스 타입은 기본 자료형으로 형변환이 불가능함.
//		그러나 문자열은 특별한 자료형이라서 Integer,Double 등의 클래스의 도움을 받으면
//		형변환이 가능.
		int number1 = Integer.parseInt(str1);  // Integer의 약자가 int, parse : 분석
